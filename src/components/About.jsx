       ...
       <div className="section grid md:grid-cols-2 md:gap-8 gap-0">
        {/* BLOC DU CONTENU */}
          <div className='text-thin my-auto py-6 md:pt-0'>
              <Slide left>
                <p>
                    Je me nomme <span className="font-semibold">Guelor Abel ANGO</span>, je suis : <br />
                ...
                <p className='mt-2 leading-7 pb-4'>
                    ...
                    j'obtient les certificats de réussite en : HTML&CSS, JAVASCRIPT, PHP&MYSQL, REACTJS, GESTION D'UN PRC INFORMATIQUE AVEVC GLPI, CONCEPTION DE RESEAU TCP/IP...
                </p>
